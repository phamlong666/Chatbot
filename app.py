...
# --- Bắt đầu phần căn giữa giao diện chính ---
# Tạo 3 cột: cột trái rỗng, cột giữa chứa nội dung chatbot, cột phải rỗng
...
with col_main_content: # Tất cả nội dung chatbot sẽ nằm trong cột này
    # Thêm logo vào giao diện chính và căn chỉnh sang trái trong cột giữa
    ...
    # Sử dụng st.columns để căn chỉnh logo sang trái trong col_main_content
